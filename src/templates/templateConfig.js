// templates/index.js - Template database ONLY (no utility exports)
...
export const LemGendTemplates = {
    ALL: [
        ...
        },
        {
            ...
            height: '512px',
            category: 'favicon',
            recommendedFormats: ['ico', 'png', 'svg'],
        ...
        },
        {
            ...
            height: '3000px',
            category: 'logo',
            recommendedFormats: ['png', 'svg', 'pdf', 'eps'],
            platforms: ['print'],
        ...
        // === EXISTING TEMPLATES FROM ORIGINAL templateConfig.js ===
        {
            ...
            height: '90px',
            category: 'web',
            recommendedFormats: ['webp', 'png', 'jpg'],
        ...
        },
        {
            ...
            height: '2in',
            category: 'print',
            recommendedFormats: ['pdf', 'png', 'jpg'],
            platforms: ['print'],
        ...
        },
        {
            ...
            height: 'variable',
            category: 'favicon',
            recommendedFormats: ['png', 'ico', 'svg'],
            platforms: ['web', 'browser'],
...
LemGendTemplates.ALL.forEach(template => {
    ...
    if (category && LemGendTemplates[category]) {
